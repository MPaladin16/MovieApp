...
class TopicCollectionViewCell: UICollectionViewCell{
    ...
    func configureCollectionView() {
        ...
        movieCollectionView.register(MovieCells.self, forCellWithReuseIdentifier: MovieCells.reuseIdentifier)
...
extension TopicCollectionViewCell: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: MovieCells.reuseIdentifier, for: indexPath) as? MovieCells
        else {
            fatalError()
        }
